...
SUBGRAPHS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "status": "implemented",
        "nodes": ["review_ai", "synthesize_candidate", "validate_candidate", "decide_promotion"],
        "tools": ["planning.build_draft", "planning.review_with_qwen", "planning.compile"],
    },
    {
        "id": "operation_execution", "label": "逐工序执行子图",
        "status": "implemented",
        "nodes": ["select_operation", "inspect_toolpath", "inspect_simulation", "verify_operation", "summarize_execution"],
        "tools": ["cam.generate_toolpath", "simulation.remove_material", "validation.check_result"],
    },
    {
...
def agent_architecture() -> dict[str, Any]:
    return {
        ...
        "tools": list(TOOLS),
        "edges": [
            ["feature_recognition", "process_planning"],
            ["process_planning", "operation_execution"],
            ["operation_execution", "validation_remediation"],
            ["validation_remediation", "operation_execution", "local_retry"],
            ["validation_remediation", "process_planning", "global_replan"],
            ["validation_remediation", "delivery", "passed"],
        ],
    }
