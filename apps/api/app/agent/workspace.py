...
ARTIFACT_CATALOG: tuple[tuple[str, str, str, str], ...] = (
    ...
    ("agent-l32-execution.json", "L32 逐工序 DRAFT 审核", "json", "operation_execution"),
    ...
    ("turning-whole-program-ir.json", "L32 整件刀路 IR", "json", "operation_execution"),
    ("turning-continuous-simulation.json", "L32 连续材料仿真", "json", "simulation"),
