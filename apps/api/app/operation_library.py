...
OPERATION_DEFINITIONS = [
    ...
    definition("engraving", "雕刻", "边加工", "沿文字或开放边链雕刻。", "Engrave",
               ["edge_chain", "sketch"], ["v_bit", "chamfer_mill"], "CM-6-90",
               [number("depth_mm", "雕刻深度", 0.2, minimum=0.01), *COMMON_MILLING], "planned", False),
    ...
    definition("surface_3d", "3D曲面精加工", "三维加工", "面向自由曲面的三轴精加工。", "Surface",
               ["surface_set", "solid"], ["ball_end_mill", "bull_end_mill"], "EM-6", [number("step_over_mm", "行距", 0.5, minimum=0.01), *COMMON_MILLING], "planned", False),
